...
from .views import (ClassListView, ClassDetailVIew, SubjectListView, SubjectDetailView, get_student_attendance,
...
urlpatterns = [
    ...
    path('attendance/<str:pk>/student', get_student_attendance, name='attendance-student'),
]
